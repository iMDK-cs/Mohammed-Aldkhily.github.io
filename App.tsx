...
import { Github, Mail, Phone, MapPin, Download, Code, Database, Server, Globe, Award, BookOpen, Briefcase, User, Menu, X, ChevronUp, Settings } from 'lucide-react';
...
function App() {
  ...
  const ADMIN_PASSWORD = 'mohammed2025';
  ...
  const skills = [
    ...
    { name: 'Database Systems', level: 85, icon: Database },
    { name: 'System Administration', level: 80, icon: Server },
    { name: 'AI/ML Algorithms', level: 75, icon: Code },
  ...
  const projects = [
    {
      ...
      description: 'Developed intelligent traffic optimization system using machine learning algorithms with real-time monitoring and dynamic signal control features.',
      technologies: ['Python', 'AI/ML', 'Real-time Processing'],
      type: 'Academic Project'
    },
    {
      title: 'Custom Gaming PC Assembly Project',
      description: 'Built and configured 15+ high-performance gaming PCs with optimal component selection and ongoing technical support.',
      technologies: ['Hardware Assembly', 'System Configuration', 'Technical Support'],
      type: 'Personal Project'
    },
    {
      title: 'Enhanced Road Safety Detection System',
      description: 'Created incident detection system for enhanced road safety using computer vision and real-time data processing.',
      technologies: ['Computer Vision', 'Python', 'Real-time Processing'],
      type: 'Academic Project'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600 rounded-xl flex items-center justify-center shadow-lg shadow-sky-500/30 animate-glow">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 animate-fade-in">
            ...
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 animate-slide-up tracking-tight">
              ...
              <br />
              <span className="text-4xl md:text-6xl text-gray-300">Aldkhily</span>
            </h1>
            <div className="text-2xl md:text-3xl text-sky-300 mb-4 h-12 flex items-center justify-center">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto animate-slide-up leading-relaxed" style={{ animationDelay: '0.3s' }}>
              Passionate about <span className="text-sky-400 font-semibold">system building</span>, 
              <span className="text-sky-400 font-semibold"> technical solutions</span>, 
          ...
          <div className="flex justify-center space-x-8 animate-bounce-in" style={{ animationDelay: '0.9s' }}>
            {[
              ...
              { icon: Mail, href: 'mailto:m7md.dk7@gmail.com', label: 'Email' },
              { icon: Phone, href: 'tel:0543156466', label: 'Phone' }
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div ref={aboutAnimation.ref} className={`${aboutAnimation.isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                Computer Science student at Al-Qassim University with practical hands-on experience 
                in system building and technical solutions, networking, and cybersecurity.
              </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-3 overflow-hidden mb-3">
                    <div 
                      className="bg-gradient-to-r from-sky-400 to-sky-600 h-3 rounded-full transition-all duration-2000 ease-out shadow-lg shadow-sky-400/30"
                      style={{ 
      ...
      <section id="contact" className="py-20 px-4 bg-gray-900/30 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-xl text-gray-300 mb-16 ${contactAnimation.isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
            Let's discuss opportunities in system building, technical solutions, or any exciting projects!
          </p>
          
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              { icon: Mail, title: 'Email', value: 'm7md.dk7@gmail.com', href: 'mailto:m7md.dk7@gmail.com' },
              { icon: Phone, title: 'Phone', value: '0543156466', href: 'tel:0543156466' },
              { icon: Github, title: 'GitHub', value: '@iMDK-cs', href: 'https://github.com/iMDK-cs' }
            ].map((contact, index) => (
              <div 
                key={index}
                className={`glass rounded-xl p-8 border border-sky-500/20 hover-lift group ${
                  contactAnimation.isVisible ? 'animate-scale-in' : 'opacity-0'
                }`}
                style={{ animationDelay: `${0.4 + index * 0.1}s` }}
              >
                <contact.icon className="text-sky-400 mx-auto mb-6 group-hover:animate-bounce" size={40} />
                <h3 className="text-xl font-semibold text-white mb-3">{contact.title}</h3>
                <a href={contact.href} className="text-gray-300 hover:text-sky-400 transition-colors text-lg font-medium">
                  {contact.value}
                </a>
              </div>
            ))}
      ...
      <footer className="py-8 px-4 border-t border-sky-500/20 relative z-20">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-400 text-lg">
            © 2025 Mohammed Aldkhily. Built with React & Tailwind CSS.
          </p>
